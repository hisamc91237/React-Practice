const VideoTitle = ({ title, overview }) => {
  return (
    <div className="w-full h-screen flex flex-col justify-center px-6 md:px-24 absolute z-20 text-white bg-linear-to-r from-black via-black/60 to-transparent">
